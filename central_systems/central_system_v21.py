...
class ChargePoint21(cp):
    ...
    def on_authorize(self, **kwargs):
        return call_result.Authorize(
            ...
            allowed_energy_transfer=[EnergyTransferModeEnumType.ac_single_phase, EnergyTransferModeEnumType.ac_three_phase,
                                     EnergyTransferModeEnumType.ac_bpt, EnergyTransferModeEnumType.dc, EnergyTransferModeEnumType.dc_bpt]
        )
